...
return [
    ...
    'view_replace_str'       => [
        ...
        '__JS__'=>"/public/js",
        "__APP__"=>"/public/index.php",// http://localhost/public/index.php
        ...
        "__ADMIN__"=> Request::instance()->domain().Request::instance()->root()."/admin",//http://localhost/public/index.php/admin
    ],
    // 默认跳转页面对应的模板文件
